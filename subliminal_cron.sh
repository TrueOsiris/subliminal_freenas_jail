...
qfile() {
	...
	then
		...
		then
			...
			lang1="nl"
			lang2="en"
			#comnd1="subliminal -l $lang1 --verbose --single --providers podnapisi opensubtitles thesubdb tvsubtitles addic7ed --addic7ed-username myuser --addic7ed-password mypass -- \"$3/$2\""
